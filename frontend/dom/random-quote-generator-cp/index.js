...
function displayQuote() {
	...
	(newQuote.citation !==  undefined) ? citation.innerHTML = newQuote.citation : citation.innerHTML = ''; 
	(newQuote.year !==  undefined) ? year.innerHTML = newQuote.year : year.innerHTML = '';
}